...
# Dynamically filter the Summary Report options based on the selected Chamber
summary_options = ["🔵 None"]
if "Satimo 1" in chamber_choice:
    summary_options.extend(["Satimo 1 Passive Report", "Satimo 1 Active Report"])
elif "Satimo 2" in chamber_choice:
    summary_options.extend(["Satimo 2 Passive Report", "Satimo 2 Active Report"])
elif "Satimo 3" in chamber_choice:
    summary_options.extend(["Satimo 3 Passive Report", "Satimo 3 Active Report"])
