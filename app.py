        ...
        if all_rows:
            ...
            for col in df_report.columns:
                if col in ["Upper Limit Result", "Lower Limit Result"]:
                    fill_color_cells.append(['#ffcccc' if 'FAIL' in str(v).upper() else '#ccffcc' if 'PASS' in str(v).upper() else '#ffffff' for v in df_report[col]])
